...
- (CGImageRef)newCapture
{
    ...
    if (is_exclude_desktop_icons) {
        ...
        NSBitmapImageRep *bitmap_desktop = [[NSBitmapImageRep alloc] initWithCGImage:cgimage_desktop];
        NSImage* image_desktop = [[NSImage alloc] init];
    ...
    NSImage *output_image = [[NSImage alloc] initWithSize:output_image_rect.size];
