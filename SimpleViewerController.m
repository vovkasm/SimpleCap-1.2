...
*/        
        ...
        _background_view = [[SimpleViewerBackgroundView alloc] initWithFrame:NSZeroRect];
        
        _filename_textfiled = [[FilenameTextField alloc] initWithController:self];
...
- (NSBitmapImageRep*)currentBitmapImageRepIsReduction:(BOOL)is_reduction {
    ...
    NSImage* new_image = [[NSImage alloc] initWithSize:new_rect.size];
