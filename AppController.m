...
@implementation AppController  {
    ...
    LaunchedApplications* _launced_applications;
...
- (id)init
{
    if (self = [super init]) {
        ...
        _icon = [NSImage imageNamed:@"status_bar_icon"];
        _icon2 = [NSImage imageNamed:@"status_bar_icon2"];
        _icon3 = [NSImage imageNamed:@"status_bar_icon3"];
...
- (void)selectApplication:(id)sender
{
    ...
    if (sender) {
        id tmp_obj = [sender representedObject];
